package com.tec.osworks.domain.model;
...
public class OrdemServico {
	...
	private  boolean podeSerCanceladaOuFinalizada() {
		return StatusOrdemServico.ABERTA.equals(getStatus());
	}
	
	private boolean naopodeSerCanceladaOuFinalizada() {
		return !podeSerCanceladaOuFinalizada();
	}

	public void finalizar() {
		if(naopodeSerCanceladaOuFinalizada()) {
