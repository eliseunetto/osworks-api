...
import com.tec.osworks.api.model.ComentarioInputModel;
import com.tec.osworks.api.model.ComentarioModel;
...
public class ComentarioController {
	...
	public ComentarioModel adicionar(@PathVariable Long ordemServicoId, @Valid @RequestBody ComentarioInputModel comentarioInputModel) {
		Comentario comentario = GestaoOrdemServico.adicionarComentario(ordemServicoId, comentarioInputModel.getDescricao());
